...
<Html transform scale={0.85} rotation={[0, 0, 0]} position={[50.549306602159675, 134.24272750605908, -110.54303079212448]} wrapperClass='screen'>
  <video controls autoPlay loop muted className='videoFrame'>
    <source src="./iotVideo.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
</Html>
<Html transform scale={0.65} rotation={[0, 0, 0]} position={[133.14303079212448, 134.24272750605908, -100.22628269127733]} wrapperClass='screen'>
  <video controls autoPlay loop muted className='videoFrame'>
    <source src="./iotVideo.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
