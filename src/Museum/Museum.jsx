...
function Museum(props,{hovered}) {
  ...
  <Building1/>
<SkillDrone position={[100, 154.5, 65]} scale={[20, 20, 20]} rotation={[THREE.MathUtils.degToRad(0),THREE.MathUtils.degToRad(-30),THREE.MathUtils.degToRad(0)]}/>
  <Telescope position={[157, 148, 60]} scale={[15, 15, 15]} rotation={[THREE.MathUtils.degToRad(0),THREE.MathUtils.degToRad(-60),THREE.MathUtils.degToRad(0)]}/>
  <Vase />
