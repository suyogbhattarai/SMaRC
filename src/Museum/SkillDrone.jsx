  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
          ...
          <group name="Collada_visual_scene_group" rotation={[Math.PI / 2, 0, 0]}>
            <group name="ControllerpCube20">
              <mesh
                ...
                position={[-11.217, 63.548, -22.047]}
                rotation={[-1.821, 0, -Math.PI]}
                scale={1.507}
              />
            </group>
            <group name="ControllerpCube23">
              <mesh
        ...
        <group name="metarig" scale={0.834}>
          <group name="Human_2">
            <skinnedMesh
              name="Human"
              geometry={nodes.Human.geometry}
              material={materials.Rex_Rough}
              skeleton={nodes.Human.skeleton}
            />
            <skinnedMesh
              name="Human_1"
              geometry={nodes.Human_1.geometry}
              material={materials.Rex_Skin}
              skeleton={nodes.Human_1.skeleton}
            />
            <skinnedMesh
              name="Human_2"
              geometry={nodes.Human_2.geometry}
              material={materials.Rex_Eyes}
              skeleton={nodes.Human_2.skeleton}
            />
            <skinnedMesh
              name="Human_3"
              geometry={nodes.Human_3.geometry}
              material={materials['Material.001']}
              skeleton={nodes.Human_3.skeleton}
            />
          </group>
          <primitive object={nodes.spine} />
          <primitive object={nodes.neutral_bone} />
        </group>
        <group name="Low_Poly_Human_2" />
        <group
          name="Drone"
          position={[0.278, 1.518, 1.335]}
