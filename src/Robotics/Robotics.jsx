...
scale={30}
      ...
      <Html  transform scale={0.85}  rotation={[-0.23,-4.71,0.24]}  position={[-55.549306602159675,134.24272750605908, -55.14303079212448]} wrapperClass='screen'>
      <iframe src="https://www.youtube.com/embed/ni5fmRGjxzs?si=sRQS3DNx1lCkiafe" className='videoFrame'/>
      </Html>  
      <Html  transform scale={0.45}  rotation={[-0.23,-4.71,0.24]}  position={[-50.549306602159675,132.24272750605908, -88.54303079212448]} wrapperClass='screen'>
      <iframe src="https://www.youtube.com/embed/ni5fmRGjxzs?si=sRQS3DNx1lCkiafe" className='videoFrame'/>
      </Html>  
      <Html  transform scale={0.55}  rotation={[0.23,4.71,0.24]}  position={[33.049306602159675,133.24272750605908, -73.14303079212448]} wrapperClass='screen'>
      <iframe src="https://www.youtube.com/embed/ni5fmRGjxzs?si=sRQS3DNx1lCkiafe" className='videoFrame'/>
      </Html>   
